...
public class GraphicsDisplay extends JPanel
{
    ...
    public GraphicsDisplay()
    {
        ...
        graphicsStroke = new BasicStroke(5.0f, BasicStroke.CAP_SQUARE, BasicStroke.JOIN_ROUND, 10.0f, new float[] {30,10,10,10,20,10,10,10,30,10}, 0.0f);
    ...
    protected void paintMarkers(Graphics2D canvas)
    {
    	   for (Double[] point : graphicsData) {
               ...
               int qwer = (int)znach;
               if(abs(znach - qwer) <= 0.1) temp = true;
